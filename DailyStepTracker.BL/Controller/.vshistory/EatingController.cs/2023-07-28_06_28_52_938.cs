    ...
    public class EatingController : BaseController
    {
        ...
        public Eating GetEating()
        {
            ...
            using (var file = new StreamReader(ProductsFileName))
            {
                ...
                else if (Newtonsoft.Json.JsonConvert.DeserializeObject<List<KeyValuePair<Food, int>>>(jsonData).ToDictionary(kv => kv.Key, kv => kv.Value) is Dictionary<Food, int> foodDict)
                {
